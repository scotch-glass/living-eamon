...
const DESTINATION_ROOMS: RoomSceneSpec[] = [
...

  {
    ...
    description: [
      "ATLANTIS AT THE HEIGHT OF THE THURIAN AGE — a thriving metropolis of",
      "wonders and ancient power. The scene captures a magnificent harbor city at",
      "the age of its glory, when Atlantean civilization stands at its peak. In",
      "the foreground, a harbor that speaks of incredible wealth and sophistication:",
      "not crude wooden docks but POLISHED STONE QUAYS carved with mathematical",
      "precision, their surface gleaming with something between stone and glass.",
      "Anchored in the harbor: ships of breathtaking design — vessels with hulls",
      "of dark polished wood, sails of fine linen in deep blues and crimsons,",
      "rigging of bronze and something glimmering (not quite metal, not quite",
      "crystal). The water itself is an impossible shade of blue-green, so clear",
      "you can see deep into it, and something GLIMMERS beneath the surface",
      "(remnants of older wonders, perhaps, or just the light). Rising from the",
      "harbor: NOT walls but TERRACES — the entire city is built in rising tiers",
      "of white marble and pale stone, with architecture that seems to defy gravity",
      "and reason. TOWERS of impossible height rise like needles or spirals into",
      "the sky. DOMES and ARCHES of such perfect geometry they seem drawn by",
      "mathematics rather than built by hand. The buildings are NOT crowded or",
      "cramped but SPACIOUS, with wide avenues and plazas visible between them.",
      "Everywhere: GARDENS and WATER FEATURES — fountains, aqueducts, channels of",
      "water flowing through the city (water flowing UPWARD in some places,",
      "defying natural law). The light is brilliant and golden, the sun catching",
      "on surfaces of almost-crystalline stone, creating a city that GLOWS. The",
      "sky is perfectly clear, a blue so deep it seems conscious. The colors are",
      "saturated and perfect: brilliant whites of marble, deep blues of sky and",
      "water, touches of gold and silver in architectural details, the rich",
      "purples and crimsons of the sails. The atmosphere is one of MAGNIFICENT",
      "ACHIEVEMENT — this is not merely a city but a STATEMENT, a declaration of",
      "civilization reaching toward the divine. No people visible, but the city",
      "PULSES with activity: fountains flowing, flags rippling, the gleam of",
      "something moving in the plazas (people? attendants? unclear at distance).",
    ].join(" "),
  },
