...
const CRITICAL_PREFIXES: Record<BodyZone, string[]> = {
  head: [
    ...
    "A killing arc — the blade finds the soft place above the ear!",
  ...
  neck: [
    ...
    "A killing line — the strike opens {defender}'s neck to the bone!",
  ...
  torso: [
    ...
    "A killing thrust — the point goes in and does not stop!",
