...
source: The Kybalion (1908/1912, Three Initiates) — Chapter V, with Hermes/Hermetic→Thoth/Thothian substitution
publicDomain: true
illuminationDelta: 3   # +Illumination toward Light on first verified read (riddle pass)
riddles:
  - prompt: "THE ALL is _____; the Universe is Mental."
    answer: "Mind"
---

# Scroll V — The Mental Universe
...
Lesson I.) comes to our aid here. The old Thothian axiom, "As above so
...
Wise Men. Such was the Teaching of Thoth.
...
But, the Thothian teaching does not imply a real duality--THE ALL is
