...
export const PD_ANCHORS: PdAnchor[] = [
  // ──────────────────────────────────────────────────────────
  {
    ...
    era: "thurian",
    blurb: "Twelve-thousand-year-old mirror-maze; reflections that whisper the name you've forgotten.",
    ...
    defaults: {
      ...
      "civilization-status": {
        optionId: "other",
        customText: "A half-forgotten sorcerer's tower in the middle of a living capital — neighbors don't quite remember who built it. The player passes it every day. Tonight, for reasons they cannot quite name, they walk up to the door.",
      },
      "location-anchor": { optionId: "valus" },
      "conflict-pattern": {
        optionId: "other",
        customText: "You enter the tower expecting curiosities. The wizard does not attack you. The mirrors do — and one of them shows you wearing a crown you do not remember earning.",
      },
      "moral-palette": {
        optionId: "other",
        customText: "Not good vs evil — selfhood vs dissolution. The pull is to step through the glass and become whoever the reflection insists you used to be. The cost is everything you currently are.",
      },
      "illumination-tilt": { optionId: "toward-dark" },
      "faction-count": {
        optionId: "other",
        customText: "One ancient sorcerer, his mirrors, and the dream-reflections that crowd behind the silver. The reflections all seem to know the player. The player does not know them back.",
      },
      "enemy-composition": {
        optionId: "other",
        customText: "A single elder sorcerer of vast psychic power, plus the silent reflections he calls forth — many of which wear the player's own face, some crowned, some bearded with grey the player has never grown.",
      },
      "combat-density": {
        optionId: "other",
        customText: "Combat is almost absent. The threat is metaphysical: every mirror is a question, and the answer takes more than blood.",
      },
      "henchman-availability": { optionId: "none" },
      "gear-gates": { optionId: "open" },
      "atom-severity": {
        optionId: "other",
        customText: "Each mirror offers a different self. One in particular calls the player majesty; the player does not remember why. Choosing which reflection to believe defines the soul; choosing badly costs identity.",
      },
      ...
      pace: {
        optionId: "other",
        customText: "Dreamlike, slow, contemplative. Every chamber lingers because every chamber is the player half-recognizing themselves.",
      },
      "reward-shape": {
        optionId: "other",
        customText: "Metaphysical insight rather than treasure — a scroll, a fragment of cosmic understanding, a permanent virtue shift, and a single glimpse of who the player may have been before the most recent rebirth.",
      },
    },
  },
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    era: "thurian",
    blurb: "Serpent-folk hidden in noble court; one of them pauses when it sees the player.",
    ...
    defaults: {
      ...
      "conflict-pattern": {
        optionId: "other",
        customText: "An infiltration mystery — serpent-folk have replaced not just courtiers but a legitimate succession the histories no longer record. The player must learn to tell the real from the worn-faced before the council convenes and the strike falls.",
      },
      "moral-palette": {
        optionId: "other",
        customText: "Every ally is a possible enemy. Trust becomes a test the player keeps failing and passing. And the serpents themselves seem to know more about the player than the player remembers about themselves.",
      },
      "illumination-tilt": { optionId: "neutral" },
      "faction-count": {
        optionId: "other",
        customText: "Two clashing factions hidden in the same court: human nobles loyal to the throne, and serpent-folk wearing those nobles' faces — wearing them well enough that some have forgotten they were ever shaped otherwise.",
      },
      "enemy-composition": {
        optionId: "other",
        customText: "Disciplined serpent-folk infiltrators with shape-changing glamour — fewer in number, deadlier than common bandits. One of them, when it first sees the player, pauses as if checking a name against a list it has carried for generations.",
      },
      "combat-density": { optionId: "occasional" },
      "henchman-availability": {
        optionId: "other",
        customText: "One canonical loyal companion — the warrior whose blade is true. (In Howard, Brule the Spearslayer; rename to taste.) He addresses the player with a deference that does not quite match their station, and will not explain why.",
      },
      "gear-gates": {
        optionId: "other",
        customText: "One uncommon gate: a relic that can pierce serpent-folk glamour — a silver weapon, a mirror, an ancient sigil. The same relic occasionally shows the player their own reflection wearing something different than what they actually wear.",
      },
      "atom-severity": {
        optionId: "other",
        customText: "Heavy moral weight: kill the wrong courtier and you've killed a friend; trust the wrong one and the throne falls. Reveal too much of what the relic shows you, and the serpents know whom they've been hunting.",
      },
      ...
      pace: {
        optionId: "other",
        customText: "Sawtooth — court intrigue and slow paranoia building to a sudden, violent revelation in the throne room. The throne is older than anyone in the room remembers.",
      },
      "reward-shape": {
        optionId: "other",
        customText: "Integrity reward for unmasking deception, Standing reward for restoring the legitimate court. Plus a fragmentary scroll of an old genealogy that lists a king long thought ended — and a date too recent for that to be true.",
      },
    },
  },
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    era: "thurian",
    blurb: "Pictish tomb-opening; an ancient king answers the call — and looks at the player first.",
    ...
    defaults: {
      ...
      "civilization-status": {
        optionId: "other",
        customText: "Borderland Pictish wilds — heather and moor, ancient cairns half-sunken in the earth, no city in sight. The cairns are older than any king the chieftains can name.",
      },
      "location-anchor": { optionId: "poi-skull-of-silence" },
      "conflict-pattern": {
        optionId: "other",
        customText: "Open war — the player's warband performs the rite to call up a long-dead king to lead the tribes against an organized invader. What comes back has eyes only for the player.",
      },
      "moral-palette": { optionId: "heroic" },
      "illumination-tilt": { optionId: "toward-light" },
      "faction-count": {
        optionId: "other",
        customText: "Two clashing forces: the tribal defenders (with the summoned king as ally) versus a disciplined imperial column. The summoned king answers the player's call by name — a name the player does not recognize as their own.",
      },
      "enemy-composition": {
        optionId: "other",
      ...
      "henchman-availability": {
        optionId: "other",
        customText: "Rotating cast — tribal chieftains, scouts, and the summoned ancient king himself as a late-arc companion. The chieftains note that the king bowed his head when he saw the player, and they will not say so where the player can hear.",
      },
      "gear-gates": {
        optionId: "other",
        customText: "One uncommon gate: a ritual relic required to call the dead king from his cairn — a horn, a blade, a sigil-stone. The relic accepts the player's touch without challenge.",
      },
      "atom-severity": {
        optionId: "other",
        customText: "Heavy — the rite carries cost. The ancient king refuses unless the sacrifice is made by the player's hand. He says, before turning to the battlefield: 'I have waited.'",
      },
      ...
      "reward-shape": {
        optionId: "other",
        customText: "Courage + Standing virtue growth. A relic of the ancient king as keepsake — and one word he speaks before returning to his cairn. The player does not understand the word. They cannot quite forget it.",
      },
    },
  },
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    era: "early-hyborian",
    blurb: "Lovecraftian desert ruin — a black gem, an empty throne, and a horror that knows the player's name.",
    ...
    defaults: {
      ...
      "civilization-status": {
        optionId: "other",
        customText: "A buried ziggurat in the deep desert — wind-carved, half-swallowed by dunes, with one perfectly preserved black-stone throne room at the center. The throne's dimensions match the player's body almost exactly. The companion notices and will not say so aloud.",
      },
      "location-anchor": { optionId: "poi-skull-of-silence" },
      "conflict-pattern": {
        optionId: "other",
        customText: "A treasure-hunt that becomes a horror — the player and a companion cross the desert to claim a famed black gem. The inscriptions in the throne room name a king the scholar cannot translate, and the scholar will admit, later, that the carved profile resembled the player.",
      },
      "moral-palette": { optionId: "damned-by-design" },
      "illumination-tilt": { optionId: "toward-dark" },
      "faction-count": {
        optionId: "other",
        customText: "Two threats — human raiders pursuing the same gem, and the elder thing in the throne room that no living tribe will name. The elder thing, when it wakes, speaks one phrase before lapsing into impossibilities: a title in a tongue centuries dead, addressed to the player.",
      },
      "enemy-composition": {
        optionId: "other",
        customText: "Mixed — pursuing raiders (lower-tier, persistent) and one cosmic-horror antagonist that wakes at the climax. The horror does not attack the player first. It bows. Then it attacks.",
      },
      "combat-density": { optionId: "climactic-only" },
      "henchman-availability": {
        optionId: "other",
        customText: "One desert-scholar companion — the only one who knows what the inscription means, and the only one who urges turning back. Pressed, the scholar will confess they have seen the player's face in a book they were not supposed to read.",
      },
      "gear-gates": {
        optionId: "other",
      ...
      "atom-severity": {
        optionId: "other",
        customText: "Defining — sit on the throne, take the gem, refuse both. Every option resonates with something the player cannot remember. No clean exit.",
      },
      "scroll-seeding": { optionId: "one-thoth" },
      length: { optionId: "short" },
      "quest-branching": { optionId: "single" },
