...
scrollNumber: 12
title: "Causation"
source: The Kybalion (1908/1912, Three Initiates) — Chapter XII, with Hermes/Hermetic→Thoth/Thothian substitution
publicDomain: true
illuminationDelta: 3   # +Illumination toward Light on first verified read (riddle pass)
riddles:
  - prompt: "Every Cause has its Effect; every Effect has its _____."
    answer: "Cause"
---

# Scroll XII — Causation
...
The great Sixth Thothian Principle--the Principle of Cause and
...
ancient and modern, and was enunciated by the Thothian Teachers in the
...
right-in fact, both sides are partially right, according to the Thothian
...
automaton-far from that. The Thothian Teachings are that Man may use Law
