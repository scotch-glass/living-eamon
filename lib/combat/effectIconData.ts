...
export const EFFECT_COLORS: Record<StatusEffectType, string> = {
  ...
  // Sprint C6.1 Stage B
  power_boon:        "#facc15",
  haste_extra_action:"#60a5fa",
  ward:              "#a3e635",
  steelskin:         "#9ca3af",
  silenced:          "#6b7280",
  resist_elemental:  "#84cc16",
};
...
export const EFFECT_ICON_MAP: Record<StatusEffectType, EffectIconDef> = {
  ...
  power_boon: {
    // Eight-pointed star (Old-Power augury sigil)
    svgPath: "M10 2L11 9L16 5L13 11L18 12L13 13L16 19L11 15L10 18L9 15L4 19L7 13L2 12L7 11L4 5L9 9Z",
    color: "#facc15",
    animation: "glow",
    label: "Power Boon",
    description: "An Old-Power boon hums in the limbs.",
  },
  haste_extra_action: {
    // Stacked chevrons (forward double-step)
    svgPath: "M4 6L10 10L4 14 M10 6L16 10L10 14",
    color: "#60a5fa",
    animation: "shimmer",
    label: "Quickened",
  ...
  ward: {
    ...
    svgPath: "M10 2L16 5L16 11L10 18L4 11L4 5Z M10 7L10 13 M7 10L13 10",
    color: "#a3e635",
    animation: "glow",
    label: "Warded",
  ...
  steelskin: {
    // Diamond plate
    svgPath: "M10 2L18 10L10 18L2 10Z M10 5L15 10L10 15L5 10Z",
    color: "#9ca3af",
    animation: null,
    label: "Steelskin",
  ...
  silenced: {
    ...
    svgPath: "M5 10L15 10 M7 7C9 5 11 5 13 7 M7 13C9 15 11 15 13 13",
    color: "#6b7280",
    animation: null,
    label: "Silenced",
    description: "Words die in the throat. Casting fizzles.",
  },
  resist_elemental: {
    // Diamond with crossed bars (anti-elemental glyph)
    svgPath: "M10 2L18 10L10 18L2 10Z M5 5L15 15 M15 5L5 15",
    color: "#84cc16",
    animation: null,
