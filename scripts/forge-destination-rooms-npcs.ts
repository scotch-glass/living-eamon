...
const DESTINATION_NPCS: NpcSpec[] = [
...

  {
    ...
    description: [
      "A PRIESTESS OR TEMPLE ADMINISTRATOR of Atlantean descent, middle-aged and",
      "authoritative. Approximately 5'7\", graceful and poised, with the bearing",
      "of someone trained from birth in ritual and authority. Her skin is pale,",
      "Mediterranean in tone, unmarked except for ritual tattoos on her",
      "forearms (symbols of her priesthood). Her hair is dark, elaborately",
      "styled and adorned with threads of gold and small charms. Her eyes are",
      "dark and intelligent, missing nothing. Her expression is calm and",
      "knowing, the expression of someone who understands deeper mysteries.",
      "",
      "She wears ceremonial garb: a long linen dress in deep indigo, pleated",
      "and falling to her sandaled feet. Over it, a richly embroidered surcoat",
      "in crimson and gold, depicting ritual symbols (waves, celestial bodies,",
      "geometric patterns). At her waist, a belt of worked metal (not modern",
      "design). On her hands, rings of silver and strange metal. Around her neck,",
      "a prominent pendant: a carved stone that seems almost to glow in certain",
      "light. Her feet are shod in simple sandals of fine leather, marked with",
      "ritual symbols. She carries a staff topped with a crystal or carved stone",
      "object of unclear purpose.",
      "",
      "POSE: She stands three-quarters to screen-right, her posture dignified and",
      "purposeful. One hand rests on her staff, the other raised as if in",
      "benediction or teaching. Her expression is serene and authoritative, her",
      "gaze slightly raised, as if looking toward higher things. Her bearing is",
      "one of spiritual authority and ancient knowledge preserved carefully",
      "through generations.",
    ].join("\n"),
    isHostile: false,
  },
