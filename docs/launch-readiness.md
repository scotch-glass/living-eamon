...
### 1. <a id="qa_annotations_batch"></a>Q+A annotations on remaining 12 design-canon docs  `priority: 102`

- **Status:** not-started
- **Source:** ~/.claude/plans/review-the-lore-and-floofy-hamming.md (Q+A pilot batch)
- **Blocks (open EVs):** EV-karma_implementation_plan-002, EV-karma_system-002, EV-module_system-001, EV-module_system-002, EV-public_domain_rules-002, EV-world_locations-001
...
### 2. <a id="pray_divinity_v1"></a>PRAY + Divinity System v1  `priority: 93`
...
### 3. <a id="brothel_temple_vd_content"></a>Brothel + Fertility Temple + VD content (GAME_DESIGN §12)  `priority: 92`
...
### 4. <a id="scrolls_of_thoth_ui"></a>15 Scrolls of Thoth — read-verification riddle UI  `priority: 92`
...
### 5. <a id="library_wiki"></a>/library wiki for creators (W2 shipped, W3 outstanding)  `priority: 91`
...
### 6. <a id="three_launch_sagas"></a>All 3 launch sagas complete (Mirrors of Tuzun Thune trilogy)  `priority: 91`
...
### 7. <a id="forty_two_oaths"></a>42 Oaths of Ma'at surfaced in gameplay  `priority: 90`
