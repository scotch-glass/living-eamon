...
scrollNumber: 10
title: "Polarity"
source: The Kybalion (1908/1912, Three Initiates) — Chapter X, with Hermes/Hermetic→Thoth/Thothian substitution
publicDomain: true
illuminationDelta: 3   # +Illumination toward Light on first verified read (riddle pass)
riddles:
  - prompt: "Everything is dual; everything has poles; everything has its pair of _____."
    answer: "opposites"
---
...
The great Fourth Thothian Principle--the Principle of Polarity embodies
...
The Thothian Teachings are to the effect that the difference between
...
And it is this fact that enables the Thothian to transmute one mental
...
A knowledge of the existence of this great Thothian Principle will
