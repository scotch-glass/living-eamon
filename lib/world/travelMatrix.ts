...
export type DangerRating = "safe" | "moderate" | "dangerous" | "extreme" | "deadly";
...
export const TRAVEL_LEGS: TravelLeg[] = [
  // ── From Valus ────────────────────────────────────────────
  {
    // Walk-to: close enough to reach on foot
    from: "valus",
  ...
  {
    // Walk-to exception: two miles from the city gate
    from: "valus",
  ...
  {
    // Walk-to exception: border lake, reachable on foot
    from: "valus",
  ...
  {
    // Horse to coast (1d) + ship crossing (3d)
    from: "valus",
    to: "nation_atlantis",
    daysFoot: null,
    daysHorse: 1,
  ...
  {
    // Horse to eastern port (2d) + ship crossing (18d)
    from: "valus",
    to: "nation_lemuria",
    daysFoot: null,
    daysHorse: 2,
  ...
  {
    // Horse to coast (1d) + ship to Atlantis (3d) + horse on island (1d)
    from: "valus",
    to: "poi_tiger_valley",
    daysFoot: null,
    daysHorse: 1,
  ...
  },
  {
    ...
    daysHorse: 2,
    daysShip: null,
    zones: ["civilization", "thurania_hills"],
    dangerRating: "dangerous",
    encounterRolls: 2,
  },
  {
    from: "valus",
    to: "geo_camoonian_desert",
    daysFoot: null,
    daysHorse: 2,
    daysShip: null,
    zones: ["civilization", "desert"],
    dangerRating: "dangerous",
    encounterRolls: 2,
  },
  {
    ...
    daysHorse: 3,
    daysShip: null,
    zones: ["civilization", "mountain"],
    dangerRating: "dangerous",
    encounterRolls: 3,
  },
  {
    // Horse to coast (1d) + ship crossing (5d)
    from: "valus",
    to: "geo_red_isles",
    daysFoot: null,
    daysHorse: 1,
  ...
  {
    // Horse to coast (1d) + ship crossing (6d)
    from: "valus",
    to: "geo_tathel_isle",
    daysFoot: null,
    daysHorse: 1,
