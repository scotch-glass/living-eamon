...
export function buildScenePrompt(
  ...
  if (!scene) {
    return `Cinematic photorealistic establishing shot of a ${tone} fantasy location. Tolkienian-GrimDark style. Extremely high definition, gritty, hyper-detailed. No text, no watermarks, no foreground characters. Dramatic directional lighting, film grain, deep shadow. ${TONE_MODIFIERS[tone]} ${STATE_MODIFIERS[state]}`;
  }

  return [
    "Cinematic photorealistic establishing shot. Tolkienian-GrimDark fantasy art style.",
    "Extremely high definition, gritty, hyper-detailed skin and surface textures.",
    "Natural subsurface scattering. Film grain. Dramatic directional lighting. Deep shadow and highlight contrast.",
    "No text. No watermarks. No foreground characters — this is a scene-setting background illustration, like a chapter illustration in a novel.",
    "",
