...
export const ITEMS: Record<string, Item> = {
  ...
  garlic: {
    id: "garlic",
    name: "Garlic Bulb",
    description: "A common garlic bulb, dried and braided. Pungent enough to ward off the merely mortal. The Order's investigators are said to weigh suspect kitchens by the pound.",
    glance: "A dried garlic bulb. Common — but watched.",
    type: "treasure",
    value: 2,
    isCarryable: true,
  },
  sulfurous_ash: {
    id: "sulfurous_ash",
    name: "Sulfurous Ash",
    description: "A pinch of grey ash from a burnt offering — bitter, faintly sulfurous. The smell lingers on the fingers for a day. Witnesses remember it.",
    glance: "Grey ash. The smell catches in the throat.",
    type: "treasure",
    value: 9,
    isCarryable: true,
  },
